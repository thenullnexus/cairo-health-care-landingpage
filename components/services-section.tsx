    ...
    <section ref={ref} className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className={`text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight transform transition-all duration-1000 ${
          ...
          <p className={`text-lg text-gray-900 max-w-3xl mx-auto mb-12 transform transition-all duration-1000 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}>
        ...
        <div className="flex h-[500px] gap-2 rounded-3xl overflow-hidden">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                ...
                />
                <div className={`absolute inset-0 ${
                  activeIndex === index ? 'bg-black/5' : 'bg-black/10'
              ...
              <div className="relative h-full flex flex-col justify-end p-6 text-white">
                ...
                <div className={`absolute top-4 left-1/2 -translate-x-1/2 bg-white text-gray-900 text-xs font-semibold tracking-wide px-4 py-1.5 rounded-full shadow-md transition-all duration-500 ${
                ...
                <div className={`flex items-center justify-center h-full transition-all duration-500 ${
                  activeIndex === index ? 'opacity-0 -translate-y-4' : 'opacity-100'
                }`}>
                ...
                {/* Expanded State */}
                <div className={`absolute bottom-6 left-0 right-0 px-6 transition-all duration-500 ${
